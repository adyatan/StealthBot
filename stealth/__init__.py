...
if ENV:
    ...
    from stealth.config import Development as Config
...
telethn = TelegramClient("stealth", API_ID, API_HASH)
...
from stealth.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler, CustomMessageHandler
