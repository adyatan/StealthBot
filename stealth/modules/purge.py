...
from stealth.modules.helper_funcs.telethn.chatstatus import user_is_admin
from stealth.modules.helper_funcs.telethn.chatstatus import can_delete_messages
from stealth.lyn import stealthbot


@stealthbot(pattern="^/purge")
