...
from stealth.modules.helper_funcs.chat_status import (
    ...
    is_user_in_chat,
    connection_status)
from stealth.modules.helper_funcs.extraction import extract_user_and_text
from stealth.modules.helper_funcs.string_handling import extract_time
from stealth.modules.log_channel import loggable, gloggable
...
def banme(bot: Bot, update: Update):
    ...
    try:
        ...
        response_message = "Ohno! something is not right please contact @stealthSupport"
...
def selfunban(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if user.id not in SUDO_USERS or user.id not in :
        return
