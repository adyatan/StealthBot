...
from stealth.modules.sql.users_sql import get_all_chats
...
def gban(bot: Bot, update: Update, args: List[str]):
    ...
    if int(user_id) in DEV_USERS:
        message.reply_text(
            "That user is part of the Team\nI can't act against our own.")
        return

    if int(user_id) in SUDO_USERS:
        message.reply_text(
            "That is a Sudo User you idiot!")
        return
    ...
    try:
        bot.send_message(
            ...
            "If you think that this was a mistake, you may appeal your ban here: @stealthSupport",
            parse_mode=ParseMode.HTML)
...
def __user_info__(user_id):
    ...
    if is_gbanned:
        ...
        text += "\n<b>Appeal Chat:</b> @stealthSupport"
    else:
        text = text.format("No")
    return text
...
*Admin only:*
 - /gbanstat
Note: You can appeal gbans or ask gbans at @stealthSupport
stealth also integrates @Spamwatch API into gbans to remove Spammers as much as possible from your chatroom!
*What is SpamWatch?*
...
stealth will constantly help banning spammers off from your group automatically So, you don't have to worry about spammers storming your group.
"""
