...
from stealth import dispatcher, BAN_STICKER, WHITELIST_USERS
...
from stealth.modules.helper_funcs.extraction import extract_text, extract_user_and_text, extract_user
from stealth.modules.helper_funcs.filters import CustomFilters
from stealth.modules.helper_funcs.misc import split_message
from stealth.modules.helper_funcs.string_handling import split_quotes
from stealth.modules.log_channel import loggable
from stealth.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        message.bot.send_sticker(chat.id, BAN_STICKER)  # stealth's sticker
        keyboard = []
        log_reason = (
