...
import stealth.modules.sql.global_bans_sql as gban_sql
import stealth.modules.sql.users_sql as user_sql
from stealth import dispatcher, OWNER_ID, DEV_USERS
