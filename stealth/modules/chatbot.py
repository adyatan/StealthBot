...
from stealth import dispatcher, AI_API_KEY, OWNER_ID
import stealth.modules.sql.chatbot_sql as sql
...
__help__ = """
Chatbot utilizes the CoffeeHouse API and allows stealth to talk back making your chat more interactive.
...
Commands: These only work for stealth Staff users.
