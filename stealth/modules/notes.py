...
from stealth import dispatcher, MESSAGE_DUMP, LOGGER
...
from stealth.modules.helper_funcs.msg_types import get_note_type
...
def list_notes(_bot: Bot, update: Update):
    ...
    msg = "*Notes in chat:*\nGet them by `/get notename` or `#notename`\n"
