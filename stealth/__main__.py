...
from stealth import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, DONATION_LINK, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL, telethn

from stealth.modules import ALL_MODULES
from stealth.modules.helper_funcs.chat_status import is_user_admin
from stealth.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("stealth.modules." + module_name)
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            buttons = InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="👥 Add stealth to your group", url="https://t.me/StealthBot?startgroup=new")],
                 [InlineKeyboardButton(text="🙋 Support Group", url="https://t.me/stealthSupport"), InlineKeyboardButton(text="🚫 Global Logs", url="https://t.me/stealthGLogs")],
                 [InlineKeyboardButton(text="❔ Help", callback_data="help_back"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/stealthUpdateLogs")]])
            message.reply_photo(
                stealth_IMG,
